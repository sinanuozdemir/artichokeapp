...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.people_generated'
        db.add_column(u'legion_query', 'people_generated',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.people_generated'
        db.delete_column(u'legion_query', 'people_generated')
