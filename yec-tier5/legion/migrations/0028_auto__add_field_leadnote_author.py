...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeadNote.author'
        db.add_column(u'legion_leadnote', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeadNote.author'
        db.delete_column(u'legion_leadnote', 'author_id')
