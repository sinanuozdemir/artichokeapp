...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Info.person_belongs_to'
        db.delete_column(u'legion_info', 'person_belongs_to_id')

        # Adding field 'Info.person'
        db.add_column(u'legion_info', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Info.person_belongs_to'
        db.add_column(u'legion_info', 'person_belongs_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Info.person'
        db.delete_column(u'legion_info', 'person_id')
