...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.personal_google_plus'
        db.add_column(u'legion_person', 'personal_google_plus',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.personal_google_plus'
        db.delete_column(u'legion_person', 'personal_google_plus')
    ...
    models = {
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 3, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 3, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
