...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.needs_emails'
        db.add_column(u'legion_query', 'needs_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Query.needs_people'
        db.add_column(u'legion_query', 'needs_people',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.needs_emails'
        db.delete_column(u'legion_query', 'needs_emails')

        # Deleting field 'Query.needs_people'
        db.delete_column(u'legion_query', 'needs_people')
