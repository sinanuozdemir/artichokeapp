...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.people_produced'
        db.add_column(u'legion_query', 'people_produced',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.emails_produced'
        db.add_column(u'legion_query', 'emails_produced',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.needs_attention'
        db.add_column(u'legion_query', 'needs_attention',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.people_produced'
        db.delete_column(u'legion_query', 'people_produced')

        # Deleting field 'Query.emails_produced'
        db.delete_column(u'legion_query', 'emails_produced')

        # Deleting field 'Query.needs_attention'
        db.delete_column(u'legion_query', 'needs_attention')
