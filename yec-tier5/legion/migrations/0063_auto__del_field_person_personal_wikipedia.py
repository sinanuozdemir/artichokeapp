...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.personal_wikipedia'
        db.delete_column(u'legion_person', 'personal_wikipedia')


    def backwards(self, orm):
        # Adding field 'Person.personal_wikipedia'
        db.add_column(u'legion_person', 'personal_wikipedia',
                      self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=100, null=True),
                      keep_default=False)
