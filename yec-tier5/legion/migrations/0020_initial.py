...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'legion_userpermissions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.User'])),
            ('user_organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Organization'], null=True)),
            ('is_team_leader', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('max_leads_per_month', self.gf('django.db.models.fields.IntegerField')(default=500)),
            ('profile_picture', self.gf('django.db.models.fields.files.FileField')(default='user_photos/no-img.jpg', max_length=100)),
        ))
        db.send_create_signal(u'legion', ['UserPermissions'])
        ...
        db.create_table(u'legion_leadnote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lead', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Lead'])),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'legion', ['LeadNote'])
        ...
        db.create_table(u'legion_query', (
            ...
            ('extra_info', self.gf('django.db.models.fields.CharField')(max_length=3000)),
            ('people_generated', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('leads_produced', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'legion_userpermissions')
        ...
        db.delete_table(u'legion_leadnote')
    ...
    models = {
        ...
        u'legion.userpermissions': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.User']"}),
            'user_organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.Organization']", 'null': 'True'})
        }
    }
