...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAddress.type_of_email'
        db.add_column(u'legion_emailaddress', 'type_of_email',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=25),
                      keep_default=False)

        # Deleting field 'Person.email'
        db.delete_column(u'legion_person', 'email')


    def backwards(self, orm):
        # Deleting field 'EmailAddress.type_of_email'
        db.delete_column(u'legion_emailaddress', 'type_of_email')

        # Adding field 'Person.email'
        db.add_column(u'legion_person', 'email',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=200),
                      keep_default=False)
