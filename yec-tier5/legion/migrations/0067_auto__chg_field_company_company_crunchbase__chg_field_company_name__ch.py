...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.company_crunchbase'
        db.alter_column(u'legion_company', 'company_crunchbase', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.name'
        db.alter_column(u'legion_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_wikipedia'
        db.alter_column(u'legion_company', 'company_wikipedia', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_twitter'
        db.alter_column(u'legion_company', 'company_twitter', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.email_pattern'
        db.alter_column(u'legion_company', 'email_pattern', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_facebook'
        db.alter_column(u'legion_company', 'company_facebook', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_angellist'
        db.alter_column(u'legion_company', 'company_angellist', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_home_page'
        db.alter_column(u'legion_company', 'company_home_page', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.company_linkedin'
        db.alter_column(u'legion_company', 'company_linkedin', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Company.location'
        db.alter_column(u'legion_company', 'location', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Company.company_crunchbase'
        db.alter_column(u'legion_company', 'company_crunchbase', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.name'
        db.alter_column(u'legion_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_wikipedia'
        db.alter_column(u'legion_company', 'company_wikipedia', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_twitter'
        db.alter_column(u'legion_company', 'company_twitter', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.email_pattern'
        db.alter_column(u'legion_company', 'email_pattern', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_facebook'
        db.alter_column(u'legion_company', 'company_facebook', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_angellist'
        db.alter_column(u'legion_company', 'company_angellist', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_home_page'
        db.alter_column(u'legion_company', 'company_home_page', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.company_linkedin'
        db.alter_column(u'legion_company', 'company_linkedin', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.location'
        db.alter_column(u'legion_company', 'location', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
