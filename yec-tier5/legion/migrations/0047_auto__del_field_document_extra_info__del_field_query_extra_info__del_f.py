...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.extra_info'
        db.delete_column(u'legion_document', 'extra_info')

        # Deleting field 'Query.extra_info'
        db.delete_column(u'legion_query', 'extra_info')

        # Deleting field 'Lead.extra_info'
        db.delete_column(u'legion_lead', 'extra_info')

        # Deleting field 'Company.extra_info'
        db.delete_column(u'legion_company', 'extra_info')

        # Deleting field 'Education.extra_info'
        db.delete_column(u'legion_education', 'extra_info')

        # Deleting field 'Job.extra_info'
        db.delete_column(u'legion_job', 'extra_info')

        # Deleting field 'File.extra_info'
        db.delete_column(u'legion_file', 'extra_info')

        # Deleting field 'Person.extra_info'
        db.delete_column(u'legion_person', 'extra_info')


    def backwards(self, orm):
        # Adding field 'Document.extra_info'
        db.add_column(u'legion_document', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'Query.extra_info'
        db.add_column(u'legion_query', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'Lead.extra_info'
        db.add_column(u'legion_lead', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'Company.extra_info'
        db.add_column(u'legion_company', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3000, blank=True),
                      keep_default=False)

        # Adding field 'Education.extra_info'
        db.add_column(u'legion_education', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'Job.extra_info'
        db.add_column(u'legion_job', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'File.extra_info'
        db.add_column(u'legion_file', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=3000),
                      keep_default=False)

        # Adding field 'Person.extra_info'
        db.add_column(u'legion_person', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 4, 15, 0, 0), max_length=10000),
                      keep_default=False)
    ...
    models = {
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.Person']", 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
