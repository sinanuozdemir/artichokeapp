...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'techComp'
        db.create_table(u'legion_techcomp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Company'])),
            ('technology', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Technology'])),
            ('date_found', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 27, 0, 0), null=True, blank=True)),
            ('date_stopped', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'legion', ['techComp'])

        # Removing M2M table for field company on 'Technology'
        db.delete_table(db.shorten_name(u'legion_technology_company'))


    def backwards(self, orm):
        # Deleting model 'techComp'
        db.delete_table(u'legion_techcomp')

        # Adding M2M table for field company on 'Technology'
        m2m_table_name = db.shorten_name(u'legion_technology_company')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('technology', models.ForeignKey(orm[u'legion.technology'], null=False)),
            ('company', models.ForeignKey(orm[u'legion.company'], null=False))
        ))
        db.create_unique(m2m_table_name, ['technology_id', 'company_id'])
    ...
    models = {
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
        ...
        u'legion.techcomp': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.Company']"}),
            'date_found': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
