...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'legion_person', 'country')

        # Deleting field 'Company.country'
        db.delete_column(u'legion_company', 'country')
