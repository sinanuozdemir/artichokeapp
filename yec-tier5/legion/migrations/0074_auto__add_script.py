...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'script'
        db.create_table(u'legion_script', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Company'])),
            ('type_of_script', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(default=None, null=True)),
            ('src', self.gf('django.db.models.fields.TextField')(default=None, null=True)),
        ))
        db.send_create_signal(u'legion', ['script'])


    def backwards(self, orm):
        # Deleting model 'script'
        db.delete_table(u'legion_script')
