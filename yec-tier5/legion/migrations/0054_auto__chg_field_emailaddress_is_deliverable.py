...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailAddress.is_deliverable'
        db.alter_column(u'legion_emailaddress', 'is_deliverable', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'EmailAddress.is_deliverable'
        db.alter_column(u'legion_emailaddress', 'is_deliverable', self.gf('django.db.models.fields.BooleanField')())
