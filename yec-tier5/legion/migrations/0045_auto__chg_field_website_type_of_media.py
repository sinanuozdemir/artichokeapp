...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Website.type_of_media'
        db.alter_column(u'legion_website', 'type_of_media', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Website.type_of_media'
        db.alter_column(u'legion_website', 'type_of_media', self.gf('django.db.models.fields.CharField')(max_length=15))
