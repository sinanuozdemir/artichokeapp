...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.personal_twitter'
        db.alter_column(u'legion_person', 'personal_twitter', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_facebook'
        db.alter_column(u'legion_person', 'personal_facebook', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_crunchbase'
        db.alter_column(u'legion_person', 'personal_crunchbase', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_angellist'
        db.alter_column(u'legion_person', 'personal_angellist', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_linkedin'
        db.alter_column(u'legion_person', 'personal_linkedin', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_home_page'
        db.alter_column(u'legion_person', 'personal_home_page', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.personal_wikipedia'
        db.alter_column(u'legion_person', 'personal_wikipedia', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Person.personal_twitter'
        db.alter_column(u'legion_person', 'personal_twitter', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_facebook'
        db.alter_column(u'legion_person', 'personal_facebook', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_crunchbase'
        db.alter_column(u'legion_person', 'personal_crunchbase', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_angellist'
        db.alter_column(u'legion_person', 'personal_angellist', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_linkedin'
        db.alter_column(u'legion_person', 'personal_linkedin', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_home_page'
        db.alter_column(u'legion_person', 'personal_home_page', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.personal_wikipedia'
        db.alter_column(u'legion_person', 'personal_wikipedia', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.website': {
            ...
            'type_of_media': ('django.db.models.fields.CharField', [], {'max_length': '25'})
        }
    }
