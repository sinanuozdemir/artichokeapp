...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field people on 'Query'
        m2m_table_name = db.shorten_name(u'legion_query_people')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('query', models.ForeignKey(orm[u'legion.query'], null=False)),
            ('person', models.ForeignKey(orm[u'legion.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['query_id', 'person_id'])


    def backwards(self, orm):
        # Removing M2M table for field people on 'Query'
        db.delete_table(db.shorten_name(u'legion_query_people'))
