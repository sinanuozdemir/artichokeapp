...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAddress.is_deliverable'
        db.add_column(u'legion_emailaddress', 'is_deliverable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAddress.is_deliverable'
        db.delete_column(u'legion_emailaddress', 'is_deliverable')
    ...
    models = {
        ...
        u'legion.emailaddress': {
            ...
            'is_deliverable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
