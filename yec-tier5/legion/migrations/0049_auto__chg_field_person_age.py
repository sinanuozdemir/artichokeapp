...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.age'
        db.alter_column(u'legion_person', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Person.age'
        db.alter_column(u'legion_person', 'age', self.gf('django.db.models.fields.IntegerField')())
