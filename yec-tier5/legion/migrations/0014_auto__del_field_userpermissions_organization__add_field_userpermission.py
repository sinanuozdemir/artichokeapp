...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPermissions.organization'
        db.delete_column(u'legion_userpermissions', 'organization')

        # Adding field 'UserPermissions.user_organization'
        db.add_column(u'legion_userpermissions', 'user_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Organization'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPermissions.organization'
        db.add_column(u'legion_userpermissions', 'organization',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'UserPermissions.user_organization'
        db.delete_column(u'legion_userpermissions', 'user_organization_id')
