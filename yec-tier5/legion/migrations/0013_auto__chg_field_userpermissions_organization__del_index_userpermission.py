...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'UserPermissions.organization' to match new field type.
        db.rename_column(u'legion_userpermissions', 'organization_id', 'organization')
        # Changing field 'UserPermissions.organization'
        db.alter_column(u'legion_userpermissions', 'organization', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'UserPermissions', fields ['organization']
        db.delete_index(u'legion_userpermissions', ['organization_id'])


    def backwards(self, orm):
        # Adding index on 'UserPermissions', fields ['organization']
        db.create_index(u'legion_userpermissions', ['organization_id'])


        # Renaming column for 'UserPermissions.organization' to match new field type.
        db.rename_column(u'legion_userpermissions', 'organization', 'organization_id')
        # Changing field 'UserPermissions.organization'
        db.alter_column(u'legion_userpermissions', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Organization'], null=True))
