...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.linkedin_bio'
        db.add_column(u'legion_company', 'linkedin_bio',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Company.twitter_bio'
        db.add_column(u'legion_company', 'twitter_bio',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.linkedin_bio'
        db.delete_column(u'legion_company', 'linkedin_bio')

        # Deleting field 'Company.twitter_bio'
        db.delete_column(u'legion_company', 'twitter_bio')
    ...
    models = {
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)'}),
        ...
        u'legion.techcomp': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.Company']"}),
            'date_found': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)', 'null': 'True', 'blank': 'True'}),
