...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'legion_technology', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('type_of_tech', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('script_alias', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal(u'legion', ['Technology'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'legion_technology')
    ...
    models = {
        ...
        u'legion.technology': {
            ...
            'company': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['legion.Company']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
