...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserPermissions.profile_picture'
        db.add_column(u'legion_userpermissions', 'profile_picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='user_photos/no-img.jpg', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserPermissions.profile_picture'
        db.delete_column(u'legion_userpermissions', 'profile_picture')
    ...
    models = {
        ...
        u'legion.userpermissions': {
            ...
            'profile_picture': ('django.db.models.fields.files.ImageField', [], {'default': "'user_photos/no-img.jpg'", 'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.User']"})
        }
    }
