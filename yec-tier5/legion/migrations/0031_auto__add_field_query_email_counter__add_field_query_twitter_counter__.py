...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.email_counter'
        db.add_column(u'legion_query', 'email_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.twitter_counter'
        db.add_column(u'legion_query', 'twitter_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Query.linkedin_counter'
        db.add_column(u'legion_query', 'linkedin_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.email_counter'
        db.delete_column(u'legion_query', 'email_counter')

        # Deleting field 'Query.twitter_counter'
        db.delete_column(u'legion_query', 'twitter_counter')

        # Deleting field 'Query.linkedin_counter'
        db.delete_column(u'legion_query', 'linkedin_counter')
