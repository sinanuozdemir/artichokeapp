...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.organization'
        db.add_column(u'legion_query', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Organization'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.organization'
        db.delete_column(u'legion_query', 'organization_id')
