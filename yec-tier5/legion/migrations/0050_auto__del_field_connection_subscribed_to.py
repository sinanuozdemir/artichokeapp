...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Connection.subscribed_to'
        db.delete_column(u'legion_connection', 'subscribed_to')

        # Adding M2M table for field subscribed_to on 'Connection'
        m2m_table_name = db.shorten_name(u'legion_connection_subscribed_to')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('connection', models.ForeignKey(orm[u'legion.connection'], null=False)),
    ...
    def backwards(self, orm):
        # Adding field 'Connection.subscribed_to'
        db.add_column(u'legion_connection', 'subscribed_to',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field subscribed_to on 'Connection'
        db.delete_table(db.shorten_name(u'legion_connection_subscribed_to'))
    ...
    models = {
        ...
        u'legion.connection': {
            ...
            'subscribed_to': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['legion.Website']", 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.Person']", 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
