...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.leads_produced'
        db.add_column(u'legion_query', 'leads_produced',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.leads_produced'
        db.delete_column(u'legion_query', 'leads_produced')
