...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'legion_education', (
            ...
            ('education_level', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'legion', ['Education'])

        # Adding M2M table for field fields_of_study on 'Education'
        m2m_table_name = db.shorten_name(u'legion_education_fields_of_study')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('education', models.ForeignKey(orm[u'legion.education'], null=False)),
            ('industry', models.ForeignKey(orm[u'legion.industry'], null=False))
        ))
        db.create_unique(m2m_table_name, ['education_id', 'industry_id'])


    def backwards(self, orm):
        # Deleting model 'Education'
        db.delete_table(u'legion_education')

        # Removing M2M table for field fields_of_study on 'Education'
        db.delete_table(db.shorten_name(u'legion_education_fields_of_study'))
