...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Person', fields ['personal_crunchbase']
        db.create_unique(u'legion_person', ['personal_crunchbase'])

        # Adding unique constraint on 'Person', fields ['personal_angellist']
        db.create_unique(u'legion_person', ['personal_angellist'])

        
        # Adding unique constraint on 'Person', fields ['personal_facebook']
        db.create_unique(u'legion_person', ['personal_facebook'])

        # Adding unique constraint on 'Person', fields ['personal_twitter']
        db.create_unique(u'legion_person', ['personal_twitter'])

        # Adding unique constraint on 'Person', fields ['personal_linkedin']
        db.create_unique(u'legion_person', ['personal_linkedin'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Person', fields ['personal_linkedin']
        db.delete_unique(u'legion_person', ['personal_linkedin'])

        # Removing unique constraint on 'Person', fields ['personal_twitter']
        db.delete_unique(u'legion_person', ['personal_twitter'])

        # Removing unique constraint on 'Person', fields ['personal_facebook']
        db.delete_unique(u'legion_person', ['personal_facebook'])

        

        # Removing unique constraint on 'Person', fields ['personal_angellist']
        db.delete_unique(u'legion_person', ['personal_angellist'])

        # Removing unique constraint on 'Person', fields ['personal_crunchbase']
        db.delete_unique(u'legion_person', ['personal_crunchbase'])
    ...
    models = {
        ...
        u'legion.person': {
            ...
            'personal_home_page': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True'}),
            ...
            'personal_wikipedia': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True'}),
