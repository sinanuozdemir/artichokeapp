...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPermissions.person'
        db.add_column(u'legion_userpermissions', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPermissions.person'
        db.delete_column(u'legion_userpermissions', 'person_id')
