...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.industry'
        db.add_column(u'legion_person', 'industry',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


        # Changing field 'Person.gender'
        db.alter_column(u'legion_person', 'gender', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.location'
        db.alter_column(u'legion_person', 'location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.photo'
        db.alter_column(u'legion_person', 'photo', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):
        # Deleting field 'Person.industry'
        db.delete_column(u'legion_person', 'industry')


        # Changing field 'Person.gender'
        db.alter_column(u'legion_person', 'gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.location'
        db.alter_column(u'legion_person', 'location', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Person.photo'
        db.alter_column(u'legion_person', 'photo', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000))
    ...
    models = {
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'legion.emailaddress': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
