...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPermissions.is_team_member'
        db.delete_column(u'legion_userpermissions', 'is_team_member')

        # Adding field 'UserPermissions.is_team_leader'
        db.add_column(u'legion_userpermissions', 'is_team_leader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserPermissions.saved_photo'
        db.add_column(u'legion_userpermissions', 'saved_photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPermissions.is_team_member'
        db.add_column(u'legion_userpermissions', 'is_team_member',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserPermissions.is_team_leader'
        db.delete_column(u'legion_userpermissions', 'is_team_leader')

        # Deleting field 'UserPermissions.saved_photo'
        db.delete_column(u'legion_userpermissions', 'saved_photo')
    ...
    models = {
        ...
        u'legion.userpermissions': {
            ...
            'saved_photo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legion.User']"})
        }
    }
