...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Website.company_belongs_to'
        db.delete_column(u'legion_website', 'company_belongs_to_id')

        # Deleting field 'Website.person_belongs_to'
        db.delete_column(u'legion_website', 'person_belongs_to_id')

        # Adding field 'Website.person'
        db.add_column(u'legion_website', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.company'
        db.add_column(u'legion_website', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Company'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Website.company_belongs_to'
        db.add_column(u'legion_website', 'company_belongs_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Company'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.person_belongs_to'
        db.add_column(u'legion_website', 'person_belongs_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Website.person'
        db.delete_column(u'legion_website', 'person_id')

        # Deleting field 'Website.company'
        db.delete_column(u'legion_website', 'company_id')
