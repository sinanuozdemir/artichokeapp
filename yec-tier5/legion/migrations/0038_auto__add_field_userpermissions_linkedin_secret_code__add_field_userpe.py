...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPermissions.linkedin_secret_code'
        db.add_column(u'legion_userpermissions', 'linkedin_secret_code',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserPermissions.linkedin_access_token'
        db.add_column(u'legion_userpermissions', 'linkedin_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserPermissions.linkedin_code_expires_in'
        db.add_column(u'legion_userpermissions', 'linkedin_code_expires_in',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPermissions.linkedin_secret_code'
        db.delete_column(u'legion_userpermissions', 'linkedin_secret_code')

        # Deleting field 'UserPermissions.linkedin_access_token'
        db.delete_column(u'legion_userpermissions', 'linkedin_access_token')

        # Deleting field 'UserPermissions.linkedin_code_expires_in'
        db.delete_column(u'legion_userpermissions', 'linkedin_code_expires_in')
    ...
    models = {
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
        ...
        u'legion.userpermissions': {
            ...
            'linkedin_code_expires_in': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 14, 0, 0)'}),
