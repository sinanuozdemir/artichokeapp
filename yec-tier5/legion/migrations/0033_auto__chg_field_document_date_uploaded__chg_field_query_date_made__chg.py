...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'legion_document', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Query.date_made'
        db.alter_column(u'legion_query', 'date_made', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Lead.date_matched'
        db.alter_column(u'legion_lead', 'date_matched', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'File.date_uploaded'
        db.alter_column(u'legion_file', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Snapshot.created_on'
        db.alter_column(u'legion_snapshot', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Person.date_added'
        db.alter_column(u'legion_person', 'date_added', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'LeadNote.date'
        db.alter_column(u'legion_leadnote', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Document.date_uploaded'
        db.alter_column(u'legion_document', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Query.date_made'
        db.alter_column(u'legion_query', 'date_made', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Lead.date_matched'
        db.alter_column(u'legion_lead', 'date_matched', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'File.date_uploaded'
        db.alter_column(u'legion_file', 'date_uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Snapshot.created_on'
        db.alter_column(u'legion_snapshot', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Person.date_added'
        db.alter_column(u'legion_person', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'LeadNote.date'
        db.alter_column(u'legion_leadnote', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'legion.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
        ...
        u'legion.lead': {
            ...
            'date_matched': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
        ...
        u'legion.leadnote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
        ...
        u'legion.query': {
            ...
            'date_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
        ...
        u'legion.snapshot': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 15, 0, 0)'}),
