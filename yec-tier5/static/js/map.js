! function () {
	...
	function b(a, b, c) {
		return this.svg = n.select(a).append("svg").attr("width", 400).attr("data-width", 400).attr("class", "datamap").attr("height", 230).style("overflow", "hidden"), this.options.responsive && (n.select(this.options.element).style({
			position: "relative",
			"padding-bottom": "60%"
	...
	}, m.prototype.worldTopo = "__WORLD__", m.prototype.usaTopo = {
		type: "Topology",
		transform: {
