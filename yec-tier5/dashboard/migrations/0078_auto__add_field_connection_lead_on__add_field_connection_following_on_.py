...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.lead_on'
        db.add_column(u'dashboard_connection', 'lead_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Connection.following_on'
        db.add_column(u'dashboard_connection', 'following_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Connection.followed_on'
        db.add_column(u'dashboard_connection', 'followed_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.lead_on'
        db.delete_column(u'dashboard_connection', 'lead_on')

        # Deleting field 'Connection.following_on'
        db.delete_column(u'dashboard_connection', 'following_on')

        # Deleting field 'Connection.followed_on'
        db.delete_column(u'dashboard_connection', 'followed_on')
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
        ...
        u'dashboard.message': {
            ...
            'date_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.messageview': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.proxy': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.scraper': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'last_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            'location': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.tweet': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)', 'null': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 28, 0, 0)'}),
