...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.from_site'
        db.add_column(u'dashboard_connection', 'from_site',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.from_site'
        db.delete_column(u'dashboard_connection', 'from_site')
