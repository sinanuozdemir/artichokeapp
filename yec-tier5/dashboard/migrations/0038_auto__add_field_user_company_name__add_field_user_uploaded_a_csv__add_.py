...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.company_name'
        db.add_column(u'dashboard_user', 'company_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)

        # Adding field 'User.uploaded_a_csv'
        db.add_column(u'dashboard_user', 'uploaded_a_csv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.tweeted_at_someone'
        db.add_column(u'dashboard_user', 'tweeted_at_someone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.referred'
        db.add_column(u'dashboard_user', 'referred',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.followed_tier5'
        db.add_column(u'dashboard_user', 'followed_tier5',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.referral_token'
        db.add_column(u'dashboard_user', 'referral_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.company_name'
        db.delete_column(u'dashboard_user', 'company_name')

        # Deleting field 'User.uploaded_a_csv'
        db.delete_column(u'dashboard_user', 'uploaded_a_csv')

        # Deleting field 'User.tweeted_at_someone'
        db.delete_column(u'dashboard_user', 'tweeted_at_someone')

        # Deleting field 'User.referred'
        db.delete_column(u'dashboard_user', 'referred')

        # Deleting field 'User.followed_tier5'
        db.delete_column(u'dashboard_user', 'followed_tier5')

        # Deleting field 'User.referral_token'
        db.delete_column(u'dashboard_user', 'referral_token')
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)'}),
