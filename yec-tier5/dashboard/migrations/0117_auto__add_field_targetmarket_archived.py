...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'targetMarket.archived'
        db.add_column(u'dashboard_targetmarket', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'targetMarket.archived'
        db.delete_column(u'dashboard_targetmarket', 'archived')
