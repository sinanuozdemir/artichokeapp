...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.settings_json'
        db.add_column(u'dashboard_user', 'settings_json',
                      self.gf('django.db.models.fields.TextField')(default='{"inbound_settings": {"toolbar": ["pop_change","period","total_people","negative_sentiment","positive_sentiment"],"period": 30}}', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.settings_json'
        db.delete_column(u'dashboard_user', 'settings_json')
