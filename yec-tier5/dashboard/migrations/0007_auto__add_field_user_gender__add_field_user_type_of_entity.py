...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'dashboard_user', 'gender',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True),
                      keep_default=False)

        # Adding field 'User.type_of_entity'
        db.add_column(u'dashboard_user', 'type_of_entity',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'dashboard_user', 'gender')

        # Deleting field 'User.type_of_entity'
        db.delete_column(u'dashboard_user', 'type_of_entity')
