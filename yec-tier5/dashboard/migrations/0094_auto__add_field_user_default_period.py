...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.default_period'
        db.add_column(u'dashboard_user', 'default_period',
                      self.gf('django.db.models.fields.IntegerField')(default=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.default_period'
        db.delete_column(u'dashboard_user', 'default_period')
    ...
    models = {
        ...
        u'dashboard.user': {
            ...
            'default_period': ('django.db.models.fields.IntegerField', [], {'default': '30', 'null': 'True'}),
