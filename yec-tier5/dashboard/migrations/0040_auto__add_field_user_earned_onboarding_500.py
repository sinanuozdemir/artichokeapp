...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.earned_onboarding_500'
        db.add_column(u'dashboard_user', 'earned_onboarding_500',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.earned_onboarding_500'
        db.delete_column(u'dashboard_user', 'earned_onboarding_500')
