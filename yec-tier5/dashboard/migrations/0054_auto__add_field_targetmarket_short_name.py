...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'targetMarket.short_name'
        db.add_column(u'dashboard_targetmarket', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'targetMarket.short_name'
        db.delete_column(u'dashboard_targetmarket', 'short_name')
