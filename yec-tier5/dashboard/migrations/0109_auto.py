...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'dashboard_user_interests')
        ...
        db.create_unique(m2m_table_name, ['user_id', 'industry_id'])


    def backwards(self, orm):
        # Removing M2M table for field interests on 'User'
        db.delete_table(db.shorten_name(u'dashboard_user_interests'))
