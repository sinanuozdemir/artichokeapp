...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.date_first_opened'
        db.alter_column(u'dashboard_message', 'date_first_opened', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Message.date_first_opened'
        db.alter_column(u'dashboard_message', 'date_first_opened', self.gf('django.db.models.fields.DateTimeField')(default=None))
