...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'statsSnapshot.number_of_connections_used'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_connections_used', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'statsSnapshot.number_of_connections_left'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_connections_left', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'statsSnapshot.number_of_analyzed_documents'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_analyzed_documents', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'statsSnapshot.number_of_connections_used'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_connections_used', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'statsSnapshot.number_of_connections_left'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_connections_left', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'statsSnapshot.number_of_analyzed_documents'
        db.alter_column(u'dashboard_statssnapshot', 'number_of_analyzed_documents', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_file_uploaded': ('django.db.models.fields.TextField', [], {'default': "''"}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)'}),
