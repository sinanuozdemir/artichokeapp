...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.google_refresh_token'
        db.add_column(u'dashboard_user', 'google_refresh_token',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'User.google_refresh_token'
        db.delete_column(u'dashboard_user', 'google_refresh_token')
