...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'targetMarket.star_limit'
        db.add_column(u'dashboard_targetmarket', 'star_limit',
                      self.gf('django.db.models.fields.DecimalField')(default=5, null=True, max_digits=3, decimal_places=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'targetMarket.star_limit'
        db.delete_column(u'dashboard_targetmarket', 'star_limit')
