...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.leads_on_list'
        db.delete_column(u'dashboard_document', 'leads_on_list')

        # Deleting field 'Document.leads_analyzed'
        db.delete_column(u'dashboard_document', 'leads_analyzed')


    def backwards(self, orm):
        # Adding field 'Document.leads_on_list'
        db.add_column(u'dashboard_document', 'leads_on_list',
                      self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2015, 4, 26, 0, 0)),
                      keep_default=False)

        # Adding field 'Document.leads_analyzed'
        db.add_column(u'dashboard_document', 'leads_analyzed',
                      self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2015, 4, 26, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 26, 0, 0)'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 26, 0, 0)'}),
