...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'keyWord.user'
        db.delete_column(u'dashboard_keyword', 'user_id')

        # Adding M2M table for field user on 'keyWord'
        m2m_table_name = db.shorten_name(u'dashboard_keyword_user')
        ...
        db.create_unique(m2m_table_name, ['keyword_id', 'user_id'])


    def backwards(self, orm):
        # Adding field 'keyWord.user'
        db.add_column(u'dashboard_keyword', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.User'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field user on 'keyWord'
        db.delete_table(db.shorten_name(u'dashboard_keyword_user'))
