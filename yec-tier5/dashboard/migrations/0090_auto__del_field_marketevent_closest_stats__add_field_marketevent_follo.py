...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'marketEvent.closest_stats'
        db.delete_column(u'dashboard_marketevent', 'closest_stats_id')

        # Adding field 'marketEvent.followers_at_the_time'
        db.add_column(u'dashboard_marketevent', 'followers_at_the_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'marketEvent.subscribers_at_the_time'
        db.add_column(u'dashboard_marketevent', 'subscribers_at_the_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'marketEvent.sentiment_at_the_time'
        db.add_column(u'dashboard_marketevent', 'sentiment_at_the_time',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'marketEvent.closest_stats'
        db.add_column(u'dashboard_marketevent', 'closest_stats',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.twitterStats'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'marketEvent.followers_at_the_time'
        db.delete_column(u'dashboard_marketevent', 'followers_at_the_time')

        # Deleting field 'marketEvent.subscribers_at_the_time'
        db.delete_column(u'dashboard_marketevent', 'subscribers_at_the_time')

        # Deleting field 'marketEvent.sentiment_at_the_time'
        db.delete_column(u'dashboard_marketevent', 'sentiment_at_the_time')
