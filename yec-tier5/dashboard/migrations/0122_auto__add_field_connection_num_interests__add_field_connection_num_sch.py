...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.num_interests'
        db.add_column(u'dashboard_connection', 'num_interests',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Connection.num_schools'
        db.add_column(u'dashboard_connection', 'num_schools',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Connection.num_titles'
        db.add_column(u'dashboard_connection', 'num_titles',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Connection.num_companies'
        db.add_column(u'dashboard_connection', 'num_companies',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Connection.star_rating'
        db.add_column(u'dashboard_connection', 'star_rating',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=6, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.num_interests'
        db.delete_column(u'dashboard_connection', 'num_interests')

        # Deleting field 'Connection.num_schools'
        db.delete_column(u'dashboard_connection', 'num_schools')

        # Deleting field 'Connection.num_titles'
        db.delete_column(u'dashboard_connection', 'num_titles')

        # Deleting field 'Connection.num_companies'
        db.delete_column(u'dashboard_connection', 'num_companies')

        # Deleting field 'Connection.star_rating'
        db.delete_column(u'dashboard_connection', 'star_rating')
