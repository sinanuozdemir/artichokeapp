...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.new_lead'
        db.add_column(u'dashboard_connection', 'new_lead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.new_lead'
        db.delete_column(u'dashboard_connection', 'new_lead')
