...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tweets on 'twitterSentiment'
        m2m_table_name = db.shorten_name(u'dashboard_twittersentiment_tweets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('twittersentiment', models.ForeignKey(orm[u'dashboard.twittersentiment'], null=False)),
            ('tweet', models.ForeignKey(orm[u'dashboard.tweet'], null=False))
        ))
        db.create_unique(m2m_table_name, ['twittersentiment_id', 'tweet_id'])


    def backwards(self, orm):
        # Removing M2M table for field tweets on 'twitterSentiment'
        db.delete_table(db.shorten_name(u'dashboard_twittersentiment_tweets'))
