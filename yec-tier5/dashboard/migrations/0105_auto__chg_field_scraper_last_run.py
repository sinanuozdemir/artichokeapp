...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dashboard_scraper', 'last_run', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Scraper.last_run'
        db.alter_column(u'dashboard_scraper', 'last_run', self.gf('django.db.models.fields.DateTimeField')())
