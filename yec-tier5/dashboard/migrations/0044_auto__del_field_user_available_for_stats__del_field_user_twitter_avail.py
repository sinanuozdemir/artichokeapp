...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.available_for_stats'
        db.delete_column(u'dashboard_user', 'available_for_stats')

        # Deleting field 'User.twitter_available_for_stats'
        db.delete_column(u'dashboard_user', 'twitter_available_for_stats')


    def backwards(self, orm):
        # Adding field 'User.available_for_stats'
        db.add_column(u'dashboard_user', 'available_for_stats',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)

        # Adding field 'User.twitter_available_for_stats'
        db.add_column(u'dashboard_user', 'twitter_available_for_stats',
                      self.gf('django.db.models.fields.IntegerField')(default=10000, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.user': {
            ...
            'pricing_plan': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)'}),
