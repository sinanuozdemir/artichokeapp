...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.num_locations'
        db.add_column(u'dashboard_connection', 'num_locations',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.num_locations'
        db.delete_column(u'dashboard_connection', 'num_locations')
