...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.twitter_available_for_stats'
        db.alter_column(u'dashboard_user', 'twitter_available_for_stats', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.twitter_available_for_stats'
        db.alter_column(u'dashboard_user', 'twitter_available_for_stats', self.gf('django.db.models.fields.IntegerField')())
