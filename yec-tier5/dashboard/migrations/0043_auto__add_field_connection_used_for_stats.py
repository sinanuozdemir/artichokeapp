...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.used_for_stats'
        db.add_column(u'dashboard_connection', 'used_for_stats',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.used_for_stats'
        db.delete_column(u'dashboard_connection', 'used_for_stats')
