...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.google_id_token'
        db.add_column(u'dashboard_user', 'google_id_token',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)

        # Adding field 'User.google_access_token'
        db.add_column(u'dashboard_user', 'google_access_token',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.google_id_token'
        db.delete_column(u'dashboard_user', 'google_id_token')

        # Deleting field 'User.google_access_token'
        db.delete_column(u'dashboard_user', 'google_access_token')
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.user': {
            ...
            'google_id_token': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
