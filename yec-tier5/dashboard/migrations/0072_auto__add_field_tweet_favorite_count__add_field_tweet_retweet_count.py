...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.favorite_count'
        db.add_column(u'dashboard_tweet', 'favorite_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Tweet.retweet_count'
        db.add_column(u'dashboard_tweet', 'retweet_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.favorite_count'
        db.delete_column(u'dashboard_tweet', 'favorite_count')

        # Deleting field 'Tweet.retweet_count'
        db.delete_column(u'dashboard_tweet', 'retweet_count')
