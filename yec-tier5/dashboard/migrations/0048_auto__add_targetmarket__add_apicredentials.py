...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'targetMarket'
        db.create_table(u'dashboard_targetmarket', (
            ...
            ('query', self.gf('django.db.models.fields.TextField')(default='', null=True)),
        ))
        db.send_create_signal(u'dashboard', ['targetMarket'])

        # Adding model 'apiCredentials'
        db.create_table(u'dashboard_apicredentials', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('social_media', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
            ('api_key', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
            ('api_secret', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
            ('access_secret', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True)),
        ))
        db.send_create_signal(u'dashboard', ['apiCredentials'])


    def backwards(self, orm):
        # Deleting model 'targetMarket'
        db.delete_table(u'dashboard_targetmarket')

        # Deleting model 'apiCredentials'
        db.delete_table(u'dashboard_apicredentials')
