...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Scraper.current_index'
        db.delete_column(u'dashboard_scraper', 'current_index')


    def backwards(self, orm):
        # Adding field 'Scraper.current_index'
        db.add_column(u'dashboard_scraper', 'current_index',
