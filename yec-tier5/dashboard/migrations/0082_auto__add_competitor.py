...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dashboard_competitor', (
        ...
        db.send_create_signal(u'dashboard', ['Competitor'])

        # Adding M2M table for field keywords on 'Competitor'
        m2m_table_name = db.shorten_name(u'dashboard_competitor_keywords')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('competitor', models.ForeignKey(orm[u'dashboard.competitor'], null=False)),
            ('keyword', models.ForeignKey(orm[u'dashboard.keyword'], null=False))
        ))
        db.create_unique(m2m_table_name, ['competitor_id', 'keyword_id'])

        # Removing M2M table for field competitors on 'User'
        db.delete_table(db.shorten_name(u'dashboard_user_competitors'))


    def backwards(self, orm):
        # Deleting model 'Competitor'
        db.delete_table(u'dashboard_competitor')

        # Removing M2M table for field keywords on 'Competitor'
        db.delete_table(db.shorten_name(u'dashboard_competitor_keywords'))

        # Adding M2M table for field competitors on 'User'
        m2m_table_name = db.shorten_name(u'dashboard_user_competitors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
