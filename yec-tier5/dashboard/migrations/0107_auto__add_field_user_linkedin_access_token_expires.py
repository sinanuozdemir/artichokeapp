...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.linkedin_access_token_expires'
        db.add_column(u'dashboard_user', 'linkedin_access_token_expires',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.linkedin_access_token_expires'
        db.delete_column(u'dashboard_user', 'linkedin_access_token_expires')
