...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Connection.twitter_available_for_stats'
        db.delete_column(u'dashboard_connection', 'twitter_available_for_stats')


    def backwards(self, orm):
        # Adding field 'Connection.twitter_available_for_stats'
        db.add_column(u'dashboard_connection', 'twitter_available_for_stats',
