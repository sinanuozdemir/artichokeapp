...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'statsSnapshot'
        db.create_table(u'dashboard_statssnapshot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.User'], null=True, blank=True)),
            ('generated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 4, 30, 0, 0))),
            ('stats', self.gf('django.db.models.fields.TextField')(default='')),
            ('number_of_connections_used', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'dashboard', ['statsSnapshot'])


    def backwards(self, orm):
        # Deleting model 'statsSnapshot'
        db.delete_table(u'dashboard_statssnapshot')
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),
