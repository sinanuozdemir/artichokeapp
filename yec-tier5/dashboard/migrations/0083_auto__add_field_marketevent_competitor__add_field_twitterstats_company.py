...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'marketEvent.competitor'
        db.add_column(u'dashboard_marketevent', 'competitor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Competitor'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'twitterStats.company'
        db.add_column(u'dashboard_twitterstats', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Company'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'marketEvent.competitor'
        db.delete_column(u'dashboard_marketevent', 'competitor_id')

        # Deleting field 'twitterStats.company'
        db.delete_column(u'dashboard_twitterstats', 'company_id')
