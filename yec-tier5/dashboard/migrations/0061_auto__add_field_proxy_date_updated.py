...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proxy.date_updated'
        db.add_column(u'dashboard_proxy', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proxy.date_updated'
        db.delete_column(u'dashboard_proxy', 'date_updated')
    ...
    models = {
        ...
        u'dashboard.proxy': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
