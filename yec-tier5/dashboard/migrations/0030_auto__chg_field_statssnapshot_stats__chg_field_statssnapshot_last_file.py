...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'statsSnapshot.stats'
        db.alter_column(u'dashboard_statssnapshot', 'stats', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'statsSnapshot.last_file_uploaded'
        db.alter_column(u'dashboard_statssnapshot', 'last_file_uploaded', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'statsSnapshot.stats'
        db.alter_column(u'dashboard_statssnapshot', 'stats', self.gf('django.db.models.fields.TextField')())

        # Changing field 'statsSnapshot.last_file_uploaded'
        db.alter_column(u'dashboard_statssnapshot', 'last_file_uploaded', self.gf('django.db.models.fields.TextField')())
