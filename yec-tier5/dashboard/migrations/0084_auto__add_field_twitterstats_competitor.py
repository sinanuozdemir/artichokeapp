...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'twitterStats.competitor'
        db.add_column(u'dashboard_twitterstats', 'competitor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Competitor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'twitterStats.competitor'
        db.delete_column(u'dashboard_twitterstats', 'competitor_id')
