...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'statsSnapshot.server_state'
        db.delete_column(u'dashboard_statssnapshot', 'server_state')

        # Deleting field 'statsSnapshot.number_of_analyzed_documents'
        db.delete_column(u'dashboard_statssnapshot', 'number_of_analyzed_documents')

        # Deleting field 'statsSnapshot.number_of_connections_left'
        db.delete_column(u'dashboard_statssnapshot', 'number_of_connections_left')

        # Deleting field 'statsSnapshot.last_file_uploaded'
        db.delete_column(u'dashboard_statssnapshot', 'last_file_uploaded')

        # Deleting field 'statsSnapshot.number_of_extra_connections'
        db.delete_column(u'dashboard_statssnapshot', 'number_of_extra_connections')


    def backwards(self, orm):
        # Adding field 'statsSnapshot.server_state'
        db.add_column(u'dashboard_statssnapshot', 'server_state',
                      self.gf('django.db.models.fields.CharField')(default='OK', max_length=25, null=True),
                      keep_default=False)

        # Adding field 'statsSnapshot.number_of_analyzed_documents'
        db.add_column(u'dashboard_statssnapshot', 'number_of_analyzed_documents',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'statsSnapshot.number_of_connections_left'
        db.add_column(u'dashboard_statssnapshot', 'number_of_connections_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'statsSnapshot.last_file_uploaded'
        db.add_column(u'dashboard_statssnapshot', 'last_file_uploaded',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)

        # Adding field 'statsSnapshot.number_of_extra_connections'
        db.add_column(u'dashboard_statssnapshot', 'number_of_extra_connections',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
        ...
        u'dashboard.marketevent': {
            ...
            'date_started': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)', 'null': 'True'}),
        ...
        u'dashboard.message': {
            ...
            'date_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.messageview': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.proxy': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.scraper': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'last_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            'location': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.tweet': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)', 'null': 'True'}),
        ...
        u'dashboard.twittersentiment': {
            ...
            'time_taken': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
        ...
        u'dashboard.user': {
            ...
            'settings_json': ('django.db.models.fields.TextField', [], {'default': '\'{"inbound_settings": {"toolbar": ["pop_change","period","total_people","negative_sentiment","positive_sentiment"],"period": 30}}\'', 'null': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 5, 0, 0)'}),
