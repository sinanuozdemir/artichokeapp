...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Connection.available_for_stats'
        db.delete_column(u'dashboard_connection', 'available_for_stats')

        # Deleting field 'Connection.new'
        db.delete_column(u'dashboard_connection', 'new')


    def backwards(self, orm):
        # Adding field 'Connection.available_for_stats'
        db.add_column(u'dashboard_connection', 'available_for_stats',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Connection.new'
        db.add_column(u'dashboard_connection', 'new',
    ...
    models = {
        ...
        u'dashboard.document': {
            ...
            'date_uploaded': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)'}),
        ...
        u'dashboard.statssnapshot': {
            ...
            'generated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'legion.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)'}),
