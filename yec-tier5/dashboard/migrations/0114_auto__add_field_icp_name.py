...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ICP.name'
        db.add_column(u'dashboard_icp', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ICP.name'
        db.delete_column(u'dashboard_icp', 'name')
