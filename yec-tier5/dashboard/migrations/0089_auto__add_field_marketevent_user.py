...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'marketEvent.user'
        db.add_column(u'dashboard_marketevent', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.User'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'marketEvent.user'
        db.delete_column(u'dashboard_marketevent', 'user_id')
    ...
    models = {
        ...
        u'dashboard.marketevent': {
            ...
            'closest_stats': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.twitterStats']", 'null': 'True', 'blank': 'True'}),
