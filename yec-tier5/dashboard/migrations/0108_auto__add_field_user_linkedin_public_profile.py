...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.linkedin_public_profile'
        db.add_column(u'dashboard_user', 'linkedin_public_profile',
                      self.gf('django.db.models.fields.TextField')(default='', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.linkedin_public_profile'
        db.delete_column(u'dashboard_user', 'linkedin_public_profile')
