...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.password_token'
        db.add_column(u'dashboard_user', 'password_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.password_token'
        db.delete_column(u'dashboard_user', 'password_token')
