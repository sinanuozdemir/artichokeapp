...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.unique_id'
        db.add_column(u'dashboard_message', 'unique_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.unique_id'
        db.delete_column(u'dashboard_message', 'unique_id')
