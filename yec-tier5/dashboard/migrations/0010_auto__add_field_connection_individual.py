...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connection.individual'
        db.add_column(u'dashboard_connection', 'individual',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connection.individual'
        db.delete_column(u'dashboard_connection', 'individual')
