...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'statsSnapshot.period'
        db.add_column(u'dashboard_statssnapshot', 'period',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'statsSnapshot.period'
        db.delete_column(u'dashboard_statssnapshot', 'period')
