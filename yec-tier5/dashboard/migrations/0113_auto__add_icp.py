...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ICP'
        db.create_table(u'dashboard_icp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.User'], null=True, blank=True)),
            ('people', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legion.Person'], null=True, blank=True)),
            ('icp_dict', self.gf('django.db.models.fields.TextField')(default='', null=True)),
            ('target_market', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.targetMarket'], null=True, blank=True)),
        ))
        db.send_create_signal(u'dashboard', ['ICP'])


    def backwards(self, orm):
        # Deleting model 'ICP'
        db.delete_table(u'dashboard_icp')
